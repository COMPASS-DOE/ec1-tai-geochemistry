...
##
## 2022-06-14
## Aaliyah Hameed and Peter Regier
# ########### #
# ########### #
...
path <- "C:/Users/hame295/OneDrive - PNNL/Documents/"


## Load in useful datasets
bulk_density <- read_csv(paste0(path, "EC1_Soil_BulkDensity_L0B_20220602.csv"))
...
ggplot(df_no_sed, aes(gwc_perc, bulk_density_g_cm3, color = transect_location)) +
  geom_point(alpha = 0.25) + 
  geom_smooth(se = F) +
...
ggplot(df_no_sed, aes(loi_perc, bulk_density_g_cm3, color = transect_location)) +
  geom_point(alpha = 0.25) + 
  geom_smooth(se = F) +
  ggtitle("Correlation Between Bulk Density Loss on Ignition ") +
  labs( y = "Bulk Density (g/cm3)", x = "LOI (%)", color = 'Transect Location') 

## Then a set of graphs relating TN/TC to LOI/GWC
ggplot(df_no_sed, aes(loi_perc, tn_perc, color = transect_location)) +
  geom_point(alpha = 0.25) + 
  geom_smooth(method = "lm", se = F) +
...
ggplot(df_no_sed, aes(loi_perc, tc_perc, color = transect_location)) +
  geom_point(alpha = 0.25) + 
  geom_smooth(method = "lm", se = F) +
...
ggplot(df_no_sed, aes(gwc_perc, tn_perc, color = transect_location)) +
  geom_point(alpha = 0.25) + 
  geom_smooth(method = "lm", se = F) +
...
ggplot(df_no_sed, aes(gwc_perc, tc_perc, color = transect_location)) +
  geom_point(alpha = 0.25) + 
  geom_smooth(method = "lm", se = F) +
...
ggplot(df_no_sed, aes(bulk_density_g_cm3, tc_perc, color = transect_location)) +
  geom_point(alpha = 0.25) + 
  geom_smooth(method = "lm", se = F) +
...
ggplot(df_no_sed, aes(bulk_density_g_cm3, tn_perc, color = transect_location)) +
  geom_point(alpha = 0.25) + 
  geom_smooth(method = "lm",se = F) +
