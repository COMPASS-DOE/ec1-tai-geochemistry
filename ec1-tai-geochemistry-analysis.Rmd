...
completeset = soilparty %>%
    select(campaign, kit_id, transect_location, bulk_density_g_cm3, gwc_perc, tn_perc, tc_perc, visible_minerals, visible_iron_oxidation, specific_conductance_us_cm, ph, region, soil_horizon, percent_clay, percent_sand) %>%
