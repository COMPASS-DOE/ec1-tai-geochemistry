...
directory = "https://drive.google.com/drive/u/0/folders/18RvjGav1OfZA8Ocdm9De7aKRaFLRrRTd"
...
metadata_file_2 <- drive_ls(metadata_directory) %>%
  filter(grepl("Metadata_CollectionLevel", name)) %>%
  pull(name)
